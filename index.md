...
:root {
  --app-background: url(https://cdn.discordapp.com/attachments/866144995022995508/1010509531224215574/unknown.png?size=4096");
  --main-color: #992727;
...
[class^=sidebar-] > nav > div:first-child,
[class^=base-] > [class^=content-] > div:nth-child(2) section[class*=container-] {
...
button[class*=lookFilled-][class*=colorGrey]:hover,
...
button[class*=colorBrand-]:not([class*=lookBlank], [class*=lookLink]):hover {
...
button[class*=colorBrand-][class*=lookInverted]:hover {
...
button[class*=lookLink-][class*=colorLink-] {
  color: var(--accent-color);
}
button[class*=lookLink-][class*=colorLink-]:hover {
  color: var(--accent-saturated);
}
button[class*=lookLink-] > [class*=contents] {
  background: none !important;
  border-bottom: 1px solid transparent;
  margin-bottom: -1px;
}
button[class*=lookLink-]:hover > [class*=contents] {
  background: none !important;
...
[class^=control-] [class^=container-][style*="hsl(139"] {
  background: var(--main-color) !important;
}
[class^=control-] [class^=container-][style*="hsl(139"] [class^=slider] path {
  fill: var(--main-color);
}
...
[class^=layerContainer-] > [class*=toolbar]::before {
  border-top-color: black !important;
}
...
[class^=channelTextArea] > [class^=container-] > [class^=containerBackground] {
  background: rgba(0, 0, 0, 0.95) !important;
  border-color: transparent;
}
[class^=channelTextArea] [class*=inner] [class^=buttons] > button:first-child {
...
[class^=drawerSizingWrapper-] > [class^=contentWrapper-] [class^=navList-] > [class^=navItem-] > [class^=navButtonActive-] {
  background: var(--main-color) !important;
}
[class^=drawerSizingWrapper-] > [class^=contentWrapper-] [class^=unicodeShortcut-],
[class^=drawerSizingWrapper-] > [class^=contentWrapper-] [class^=inspector-] {
  background: #000;
}
...
[class*=chatContent] form > div > [class^=wrapper] {
  background: rgba(0, 0, 0, 0.3);
}

[class*=chatContent] button:not([class*=lookBlank], [class*=barButtonBase]) {
  background: var(--main-color) !important;
  color: var(--button-text) !important;
}
[class*=chatContent] button:not([class*=lookBlank], [class*=barButtonBase]):hover {
  background: var(--main-color-selected) !important;
  color: var(--button-text-selected) !important;
}
...
[class*=reactions-] [class*=reaction]:not([class^=reactionCount], [class^=reactionBtn]):hover {
  border-color: transparent;
}
[class*=reactions-] [class*=reaction]:not([class^=reactionCount], [class^=reactionBtn]) img {
  width: 30px !important;
  height: 30px !important;
}
[class*=reactions-] [class*=reaction]:not([class^=reactionCount], [class^=reactionBtn])[class*=reactionMe] {
...
[class^=layerContainer-] [class^=layer-] [class*=reactors-] {
  background: transparent !important;
}
[class^=layerContainer-] [class^=layer-] [class*=reactors-] div:not([class*=contents]) {
  background: rgba(0, 0, 0, 0.95) !important;
}
[class^=layerContainer-] [class^=layer-] [class*=menu-] {
  background: rgba(0, 0, 0, 0.95) !important;
  box-shadow: none !important;
}
[class^=layerContainer-] [class^=layer-] [class*=menu-] [class*=wrapper-] img {
  width: 30px !important;
  height: 30px !important;
}
...
[class*=layer] [class*=wrapper] [class*=emojiPicker] {
  background: rgba(0, 0, 0, 0.95) !important;
}
[class*=layer] [class*=wrapper] [class*=emojiPicker] [class*=emojiItem] {
  transition: transform 0.2s ease-in-out;
}
[class*=layer] [class*=wrapper] [class*=emojiPicker] [class*=emojiItemSelected] {
...
#status-picker-online[class*=focused] {
  background: #43b58244;
}
#status-picker-idle {
  color: #faa61a;
}
#status-picker-idle[class*=focused] {
  background: #faa81a42;
}
#status-picker-dnd {
  color: #f04747;
}
#status-picker-dnd[class*=focused] {
  background: #b83a3c3d;
}
#status-picker-invisible {
  color: #747f8d;
}
#status-picker-invisible[class*=focused] {
  background: #747f8d3d;
}
#status-picker-custom-status[class*=focused] {
  background: #ff4db53d;
}
...
[class*=sidebar] [class*=containerDefault] [class*=modeSelected] [class*=content] {
  background: var(--main-color-semitransparent-selected) !important;
  color: #ffffff !important;
}
[class*=sidebar] [class*=containerDefault]:hover [class*=modeSelected] [class*=content] {
  background: var(--main-color-semitransparent-selected) !important;
}
[class*=sidebar] [class*=containerDefault] [class^=children] > [class^=icon]:nth-last-child(3) {
  display: none !important;
}
...
[class^=content-] > [class^=emojiRow-][class*=card-] {
  background: transparent !important;
}
...
[role=radiogroup] [aria-checked=true] [style*="hsl(139)"] {
  background: rgba(0, 230, 77, 0.3) !important;
}

[role=radiogroup] [aria-checked=true] [style*="hsl(38"] {
  background: rgba(255, 196, 0, 0.3) !important;
}

[role=radiogroup] [aria-checked=true] [style*="hsl(21"] {
  background: rgba(242, 97, 0, 0.3) !important;
}

[role=radiogroup] [aria-checked=true] [style*="hsl(359"] {
  background: rgba(244, 40, 40, 0.3) !important;
}
...
div[class^=bannedUser-][class*=card-] {
  background: transparent !important;
}
div[class^=bannedUser-][class*=card-] span {
...
[class^=tileChild-] button > [class*=button-]:hover {
  color: var(--button-text-selected);
}
...
[class^=pictureInPictureVideo-] > span button > [class*=button-]:hover {
  background: var(--main-color-selected);
  color: var(--button-text-selected);
}
...
[class^=userPopout] [class^=bodyInnerWrapper],
[class^=userPopout] [class^=footer],
[class^=userPopout] [class^=avatar] {
  background: transparent !important;
  border-color: transparent !important;
}
[class^=userPopout] [class^=body][style] {
  overflow: hidden !important;
  padding: 0;
  padding-right: 0 !important;
}
[class^=userPopout] [class*=divider] {
  display: none;
}
[class^=userPopout] #permissions-popout,
[class^=userPopout] h3:not([class*=nickname], [class*=ellipsis]),
[class^=userPopout] [class*=rolesList]:not([class*=member-perm]),
[class^=userPopout] [class*=textarea],
[class^=userPopout] div[class*=customStatus],
[class^=userPopout] [class*=userInfoBody] {
  padding-left: 16px;
  padding-right: 16px;
}
...
[class^=userPopout] [class*=userInfoSection] {
  margin-top: 20px;
}
[class^=userPopout] [class*=member-perms-title] {
...
[class^=userPopout] textarea {
  padding-left: 32px !important;
  padding-right: 16px;
}
[class^=userPopout] [class*=rolesList] > [class*=role] {
  position: relative;
  margin: 0 -12px 4px 0;
}
[class^=userPopout] [class*=rolesList] > [class*=role] [class*=roleRemoveButton] {
  cursor: pointer;
  position: unset;
  width: 20px;
  height: 10px;
}
[class^=userPopout] [class*=rolesList] > [class*=role] [class*=roleRemoveButton] svg {
  opacity: 0;
}
[class^=userPopout] [class*=rolesList] > [class*=role] [class*=roleCircle] {
  position: absolute;
  width: calc(100% - 18px);
  margin: 0;
  border-radius: 4px;
...
[class^=userPopout] [class*=rolesList] > [class*=role] [class*=roleName] {
  z-index: 2;
  margin-left: 4px;
  margin-right: 8px;
...
[class^=userPopout] [class*=rolesList] > [class*=role] [class*=roleName]::before {
  content: "";
  position: absolute;
  width: 0px;
  height: 10px;
...
[class^=userPopout] [class*=rolesList] > [class*=role]:hover [class*=roleName] {
  transform: translateX(-8px);
}
[class^=userPopout] [class*=rolesList] > [class*=role]:hover [class*=roleName]::before {
  width: 10px;
...
[class^=activityUserPopout-] [class*=platformIcon] {
...
[class^=activityUserPopout-] [class^=bar-] {
  background: rgba(0, 0, 0, 0.2) !important;
}
[class^=activityUserPopout-]::before {
  content: "";
  position: absolute;
  height: 21px;
  z-index: 1;
...
[class^=activityUserPopout-]::after {
  content: "";
  position: absolute;
  height: 21px;
  z-index: 1;
...
[role=radiogroup] [aria-checked=true] [style*="hsl(37"] {
...
[class^=slider-] > [class^=track-] > [class^=mark-] [class^=markValue-] {
  color: rgba(255, 255, 255, 0.5) !important;
}
[class^=slider-] > [class^=track-] > [class^=mark-] [class^=markDash-] {
...
[class*=accountProfileCard] [class*=fieldButton-] {
  background: var(--main-color) !important;
  color: var(--button-text) !important;
}
[class*=accountProfileCard] [class*=fieldButton-]:hover {
  background: var(--main-color-selected) !important;
  color: var(--button-text-selected) !important;
}
...
[class^=standardSidebarView] > [class^=sidebarRegion] [class^=sidebar-] [class*=item]:hover {
  background: var(--main-color-semitransparent) !important;
  color: var(--button-text) !important;
}
[class^=standardSidebarView] > [class^=sidebarRegion] [class^=sidebar-] [class*=item][class*=selected] {
  background: var(--main-color-semitransparent-selected) !important;
  color: var(--button-text-selected) !important;
}
[class^=standardSidebarView] > [class^=sidebarRegion] [class^=sidebar-] [class*=item][aria-controls=discord-nitro-tab] svg {
  display: none;
}
[class^=standardSidebarView] > [class^=sidebarRegion] [class^=sidebar-] [class*=item] [class*=selectedBackground] {
  background: transparent !important;
}
...
[class^=carousel] [class^=tier-] [class*=tierHeader] {
  background: rgba(0, 0, 0, 0.1) !important;
}
[class^=carousel] [class^=tier-] [class*=tierHeaderLocked] path {
  fill: rgba(255, 255, 255, 0.5);
}
[class^=carousel] [class^=tier-] [class*=tierBody] {
  background: transparent !important;
}
...
[class^=tiers] > [class^=tier-] [class*=tierHeader] {
  background: rgba(0, 0, 0, 0.1) !important;
}
[class^=tiers] > [class^=tier-] [class*=tierHeaderLocked] path {
  fill: rgba(255, 255, 255, 0.5);
}
[class^=tiers] > [class^=tier-] [class*=tierBody] {
  background: transparent !important;
}
